% This agent model has an abnormality in outcome sensor matrix A !!!
function mdp = Model2(var)
...
for k = 1:Nf(f2)
  for j = 1:Nf(1)
    ...
    % Sensory error: agent can mistakenly feel homeostasis/dyshomeostasis
    A{o1}(:,j,k) = normpdf(1:No(1),abs(k-j)+1, var);
  end
end
